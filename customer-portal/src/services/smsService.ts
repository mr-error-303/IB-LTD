...
class SMSService {
  ...
  async sendTransactionSMS(
    ...
    try {
      ...
      this.notifications.push(notification);
      const appError = handleError(error, 'SMSService');
      log.error('SMS sending failed', appError, 'SMSService');
      return notification;
    }
  }
  ...
  async sendSecuritySMS(
    ...
    try {
      ...
      this.notifications.push(notification);
      const appError = handleError(error, 'SMSService');
      log.error('Security SMS sending failed', appError, 'SMSService');
      return notification;
    }
  }
  ...
  async sendBillPaymentSMS(
    ...
    try {
      ...
      this.notifications.push(notification);
      const appError = handleError(error, 'SMSService');
      log.error('Bill payment SMS sending failed', appError, 'SMSService');
      return notification;
    }
  }
  ...
  async sendMobileRechargeSMS(
    ...
    try {
      ...
      this.notifications.push(notification);
      const appError = handleError(error, 'SMSService');
      log.error('Mobile recharge SMS sending failed', appError, 'SMSService');
      return notification;
    }
  }
