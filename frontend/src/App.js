...
import TestTransactionDashboard from './components/TestTransactionDashboard';
    ...
    <AuthProvider>
      <NotificationProvider>
        <Router>
          ...
          {/* Test Route - Direct access to Transaction Approval Dashboard */}
          <Route path="/test-transaction-approval" element={<TestTransactionDashboard />} />
          ...
          <Route path="/admin/transaction-approval" element={
            <ProtectedRoute>
              <AdminSecurityProvider>
                <AdminLayout
                  title="Transaction Approval System"
                  notifications={[]}
                  onClearNotifications={() => {}}
                  onRemoveNotification={() => {}}
                  connectionStatus="Connected"
          ...
          <Route path="/admin/loans/applications" element={
            <ProtectedRoute>
              <AdminSecurityProvider>
                <AdminLayout
          ...
          <Route path="/admin/loans/approval" element={
            <ProtectedRoute>
              <AdminSecurityProvider>
                <AdminLayout
                  title="Loan Approval"
          ...
          <Route path="/admin/loans/disbursement" element={
            <ProtectedRoute>
              <AdminSecurityProvider>
                <AdminLayout
          ...
          <Route path="/admin/loans/portfolio" element={
            <ProtectedRoute>
              <AdminSecurityProvider>
                <AdminLayout
